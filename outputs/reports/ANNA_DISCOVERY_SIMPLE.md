...
CFB (Qubic’s founder) revealed the existence of a **128 x 128 matrix** (16,384 numbers with byte values 0–255), and https://x.com/MKx2x10 as well as the one and only https://x.com/QubicChurch put it into a grid. Each matrix cell can be transformed into a **60-character identity** that is verifiable on-chain. In short:
