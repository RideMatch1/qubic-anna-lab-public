...
identities = ["YSGDHHDFBDERGBSJQMJVGEELNPKBZXGQEWMAKKCXKEFEVOYZNPRFLIMEFKRK", "BZBQFLLBNCXEMGLOBHUVFTLUPLVCPQUASSILFABOFFBCADQSSUPNWLZBQEXK", "BASQAYABTREJCHNUPQVBETQMHMWCQDGXLOYZJGLJPFNIJZARILUBTKSAWFXB", "EMSDNEPXAFTZJBFRCVQHGRQRRJOAACLHLKKNDHUYBDMDFCJVRMOAKKTAFQEC"]
methods = ["Reverse XOR", "Alternating XOR", "Weighted Sum", "First/Last Half XOR"]
...
with open("outputs/derived/master_seed_fusion_layer1_extended_rpc_check.json", "w") as f:
